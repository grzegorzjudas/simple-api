...
define("DB_COL_USERS_PWD", "password");
define("DB_COL_USERS_EMAIL", "email");
define("DB_COL_USERS_ALEVEL", "access_level");
...
define("DB_COL_SESSIONS_USERID", "users_id");
define("DB_COL_SESSIONS_TOKEN", "token");
define("DB_COL_SESSIONS_CREATED", "created");
define("DB_COL_SESSIONS_LASTUSED", "last_used");
